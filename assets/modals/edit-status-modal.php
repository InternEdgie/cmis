			...
			<form method="POST" id="updateStatus<?= $row['status_id'] ?>">
				...
				<div class="modal-body">
					<div class="form-group">
						...
						<input type="text" class="form-control" placeholder="Enter status..." id="status" value="<?= $row['status_name'] ?>" name="status" required>
					</div>
					<div class="form-group">
						<label for="description">Description:</label>
						<textarea class="form-control" placeholder="Enter description..." id="description" value="<?= $row['status_description'] ?>" name="description" required><?= $row['status_description'] ?></textarea>
					</div>
				</div>
