...
if ($res_id != 'add') {
	...
	if ($connection->query($add_lupon_query)) {
		...
		$message = "<b>" . $fullname . "</b> appointed as one of the Lupong Tagapamayapa.";
		$flag = 1;
	} else {
	...
	if ($connection->query($query) === TRUE) {
		...
		$message = "<b>" . $first_name . ' ' . $middle_name . ' ' . $last_name . "</b> has been added to the resident and lupon record.";
		$flag = 1;
	} else {
		$message = "Something went wrong. Please try again later.";
		$flag = 0;
